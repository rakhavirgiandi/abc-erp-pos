...
<head>
    ...
    <link rel="icon" type="image/png" sizes="512x512" href="{{ asset('assets/images/favicon/android-chrome-512x512.png') }}">
     ...
     <!-- TITLE -->
     <title>Hapus Akun - {{env('APP_NAME')}} </title>
...
<body class="app sidebar-mini ltr login-img">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control ms-0" type="email" placeholder="Enter your Email" name="email">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="d-grid mb-3">
                                                <button class="btn btn-danger" type="submit">Request Hapus Akun</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
    ...
    <script type="text/javascript">
        ...
        $('form#form-login').submit(function(e) {
            ...
            $.ajax({
                type: 'post',
                url: BASE_URL + '/api/user_delete_requests',
                data: form_data,
                cache: false,
                contentType: false,
                processData: false,
                    ...
                    if (res.status == 'success') {
                        setTimeout(function() {
                            Swal.fire({
                                ...
                                window.location.replace('https://mandep.id');
                            });
                        }, 500);
                    } else {
                        Swal.fire({
