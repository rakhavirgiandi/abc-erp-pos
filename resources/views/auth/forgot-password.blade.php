...
<body class="app sidebar-mini ltr login-img">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control ms-0" type="email" id="email" name="email" placeholder="Silahkan masukkan email Anda">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="d-grid mb-3">
                                                <button class="btn btn-primary btn-block" type="submit">Kirim Reset Password Link</button>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        $('form#main-form').submit(function(e) {
            ...
            $.ajax({
                type: 'post',
                url: BASE_URL + '/api/forgot_passwords',
                data: form_data,
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function(res) {
                    if (res.status == 'success') {
                        Swal.fire({
                            title: "Sukses",
                            text: "Silahkan cek Email anda pada Kotak Masuk ataupun Spam!",
                            icon: "success"
                        }).then((result) => {
