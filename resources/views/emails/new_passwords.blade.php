...
<head>
    ...
    <title>Password Baru Aplikasi SAKOLA Anda</title>
        ...
        <div class="mail-content" style="padding: 10px 10px; background-color: #fff; border-radius: 16px; border: 1px solid #E6ECEC;">
            ...
            <div class="body-email" style="padding: 24px; border: 1px solid #E6ECEC; border-radius: 12px;">
                <div class="part">
                    ...
                    <p style="margin-top: 0px;">Anda telah melakukan pergantian password pada aplikasi SAKOLA</p>
                </div>
                <hr style="border: 1px solid #e6ecec; border-top: 0px;">
                <div class="part">
                    <h4 style="margin-top: 0px; margin-bottom: 6px;">Detail Password Baru SAKOLA Anda : </h4>
                    <table>
                        <tr>
                            <td>Email</td>
                            <td>:</td>
                    ...
                    <p style="margin-top: 0px;">Harap berhati - hati, jangan bagikan password Anda kepada orang lain dan simpan email ini dengan baik.</p>
                    <p>Anda dapat menghubungi <a href="https://api.whatsapp.com/send/?phone=6281908080017&text=halo+SAKOLA+,+jadwalkan+saya+presentasi&type=phone_number&app_absent=0" style="color: #FC7C3C; text-decoration: none;">Customer Service SAKOLA</a> jika terdapat kendala pada aplikasi.</p>
                    <p>Terimakasih.</p>
                </div>
