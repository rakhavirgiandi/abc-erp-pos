...
@section('modal')
    @include('pos.cashier.modal.product')
    @include('pos.cashier.modal.product_note')
    @include('pos.cashier.modal.customer')
    @include('pos.cashier.modal.unit')
    @include('pos.cashier.modal.payment')
    @include('pos.cashier.modal.redeem')
    @include('pos.cashier.modal.authenticate')
    @include('pos.cashier.modal.histories')
    @include('pos.cashier.modal.taxes')
    @include('pos.cashier.modal.stock')
    @include('pos.cashier.modal.sync')
@endsection
...
<script>
    $(function() {
        ...
        const setCustomerDefaultValue = () => {
            $.ajax({
                type: 'get',
                url: BASE_URL + "/api/contacts/"+'{{ config('settings.default_customer') }}',
                "headers": {
                    'Authorization': TOKEN
                },
                beforeSend: function () {
        ...
        const generateRefNumber = (refNumber = null) => {
            ...
            if (!refNumber) {
                $.ajax({
                    url: BASE_URL + '/api/pos/generate_ref_numbers',
                    type: "GET",
                    dataType: "json",
                    headers: {
                        'Authorization': TOKEN,
        ...
        function loadProducts(props = {}) {
            ...
            $.ajax({
                url: BASE_URL + '/api/products?'+reqParams,
                type: "GET",
                dataType: "json",
                headers: {
                    'Authorization': TOKEN,
        ...
        const loadProductCategories = () => {
            ...
            $.ajax({
                url: BASE_URL + '/api/product_categories?'+reqParams,
                type: "GET",
                dataType: "json",
                headers: {
                    'Authorization': TOKEN,
        ...
        const loadRewardPointProducts = (props) => {
            ...
            $.ajax({
                url: BASE_URL + '/api/reward_points?'+reqParams,
                type: "GET",
                dataType: "json",
                headers: {
                    'Authorization': TOKEN,
        ...
        function loadUnits(props = {}) {
            ...
            $.ajax({
                url: BASE_URL + '/api/units?'+reqParams,
                type: "GET",
                dataType: "json",
                headers: {
                    'Authorization': TOKEN,
        ...
        const loadPaymentMethod = (props) => {
            ...
            $.ajax({
                url: BASE_URL + '/api/bank_accounts?'+reqParams,
                type: "GET",
                dataType: "json",
                headers: {
                    'Authorization': TOKEN,
        ...
        $(document).on('shown.bs.modal', '#payment-modal', function () {
            if (selectedCustomer?.id) {
                ...
                if (selectedCustomer?.contact_group_id) {
                    $.ajax({
                        url: BASE_URL + '/api/contact_groups/'+selectedCustomer?.contact_group_id+'/generate_reward_points',
                        type: "GET",
                        dataType: "json",
                        data: params,
                        headers: {
        ...
        function loadHistories(props = {}) {
            ...
            $.ajax({
                url: BASE_URL + '/api/sales_invoices?'+reqParams,
                type: "GET",
                dataType: "json",
                headers: {
                    'Authorization': TOKEN,
        ...
        $(document).on('click', '[id^=call-back-sales-invoice-]', function () {
            ...
            withShortcutSwal({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: BASE_URL + '/api/sales_invoices/'+dataId+'?'+reqParams,
                        type: "GET",
                        dataType: "json",
                        headers: {
                            'Authorization': TOKEN,
        ...
        const currenciesSync = () => {
            return  $.ajax({
                        url: BASE_URL+'/api/sync/currencies',
                        method: 'GET',
                        contentType: 'application/json',
                        headers: { 'Authorization': TOKEN },
                    });
        ...
        const defaultAccountsSync = () => {
            return  $.ajax({
                        url: BASE_URL+'/api/sync/default_accounts',
                        method: 'GET',
                        contentType: 'application/json',
                        headers: { 'Authorization': TOKEN },
                    });
        ...
        $(document).on('input', '#input-point', function () {
            ...
            typingTimer = setTimeout(() => {
                ...
                $.ajax({
                    url: BASE_URL + '/api/pos/discount_point_exchange',
                    type: "GET",
                    dataType: "json",
                    data: params,
                    headers: {
