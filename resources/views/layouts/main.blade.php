...
<body class="horizontal-layout">
    ...
    <div id="layout-wrapper">
        ...
        @if (Request::segment(1) == 'pos' && Request::segment(2) == 'cashier')
            @include('layouts.pos.cashier.header')
        @elseif (Request::segment(1) == 'pos' && Request::segment(2) == 'settings')
            @include('layouts.pos.settings.header')
        @else
        ...
        @if (Request::segment(1) == 'pos' && Request::segment(2) == 'cashier')
        @elseif (Request::segment(1) == 'pos' && Request::segment(2) == 'settings')
            @include('layouts.pos.settings.navbar')
        @elseif (Request::segment(1) == 'hrm')
            @include('layouts.navbar_hrm')
        @else
        ...
        <div class="main-content">
            ...
            <!-- Begin Footer -->
            @if (Request::segment(1) == 'pos' && Request::segment(2) == 'cashier')
            @include('layouts.pos.cashier.footer')
            @elseif (Request::segment(1) == 'pos' && Request::segment(2) == 'settings')
            @else
