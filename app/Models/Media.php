...
class Media extends Model
{
     ...
     */
    protected $casts = [
        'model' => 'string', 'model_id' => 'int', 'type' => 'string', 'original_name' => 'string', 'filepath' => 'string', 'filename' => 'string', 'filesize' => 'string', 'mime' => 'string', 'extension' => 'string', 'url' => 'string', 'provider' => 'string', 'provider_response_id' => 'string', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'original_name' => ['column' => $model->table.'.original_name', 'alias' => 'original_name', 'type' => 'string'],
				'filepath' => ['column' => $model->table.'.filepath', 'alias' => 'filepath', 'type' => 'string'],
				'filename' => ['column' => $model->table.'.filename', 'alias' => 'filename', 'type' => 'string'],
				'filesize' => ['column' => $model->table.'.filesize', 'alias' => 'filesize', 'type' => 'string'],
				'mime' => ['column' => $model->table.'.mime', 'alias' => 'mime', 'type' => 'string'],
				'extension' => ['column' => $model->table.'.extension', 'alias' => 'extension', 'type' => 'string'],
				'url' => ['column' => $model->table.'.url', 'alias' => 'url', 'type' => 'string'],
				'provider' => ['column' => $model->table.'.provider', 'alias' => 'provider', 'type' => 'string'],
				'provider_response_id' => ['column' => $model->table.'.provider_response_id', 'alias' => 'provider_response_id', 'type' => 'string'],
