...
class ModelHasPermissions extends Model
{
     ...
     */
    protected $casts = [
        'model_type' => 'string', 'model_id' => 'int'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
                'permission_id' => ['column' => $model->table.'.permission_id', 'alias' => 'permission_id', 'type' => 'int'],
				'model_type' => ['column' => $model->table.'.model_type', 'alias' => 'model_type', 'type' => 'string'],
    ...
    public static function getById($id, $params = [], $request = null)
    {
        ...
        $db = ModelHelper::select($schema['field'], $request, __CLASS__)->where($models->table.'.permission_id', $id);
