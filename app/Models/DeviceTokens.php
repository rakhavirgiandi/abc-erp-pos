...
class DeviceTokens extends Model
{
    ...
    */
     ...
     */
    protected $casts = [
        'user_id' => 'string', 'company_id' => 'string', 'token' => 'string', 'token_type' => 'string', 'expires_at' => 'datetime', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'token_type' => ['column' => $model->table.'.token', 'alias' => 'token', 'type' => 'string'],
