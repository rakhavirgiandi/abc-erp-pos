...
class PointHistories extends Model
{
     ...
     */
    protected $casts = [
        'model' => 'string', 'model_id' => 'int', 'contact_id' => 'int', 'point' => 'int', 'note' => 'string', 'date' => 'datetime', 'type' => 'string', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'point' => ['column' => $model->table.'.point', 'alias' => 'point', 'type' => 'int'],
