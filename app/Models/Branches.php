...
class Branches extends Model
{
     ...
     */
    protected $casts = [
        'code' => 'string', 'name' => 'string', 'branch_head_id' => 'int', 'is_active' => 'int', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'branch_head_id' => ['column' => $model->table.'.branch_head_id', 'alias' => 'branch_head_id', 'type' => 'int'],
