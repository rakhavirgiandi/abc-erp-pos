 ...
 * @property string vice_chairman_name
...
'code',
     ...
     */
    protected $casts = [
        'code' => 'string', 'name' => 'string', 'chairman_name' => 'string', 'vice_chairman_name' => 'string', 'address' => 'string', 'city' => 'string', 'phone' => 'string', 'created_at' => 'timestamp', 'updated_at' => 'timestamp'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'chairman_name' => ['column' => $model->table.'.chairman_name', 'alias' => 'chairman_name', 'type' => 'string'],
				'vice_chairman_name' => ['column' => $model->table.'.vice_chairman_name', 'alias' => 'vice_chairman_name', 'type' => 'string'],
