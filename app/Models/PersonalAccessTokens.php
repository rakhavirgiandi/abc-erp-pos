...
class PersonalAccessTokens extends Model
{
     ...
     */
    protected $casts = [
        'tokenable_type' => 'string', 'tokenable_id' => 'int', 'name' => 'string', 'token' => 'string', 'abilities' => 'string', 'last_used_at' => 'datetime', 'expires_at' => 'datetime', 'created_at' => 'datetime', 'updated_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'tokenable_type' => ['column' => $model->table.'.tokenable_type', 'alias' => 'tokenable_type', 'type' => 'string'],
				'tokenable_id' => ['column' => $model->table.'.tokenable_id', 'alias' => 'tokenable_id', 'type' => 'int'],
				'name' => ['column' => $model->table.'.name', 'alias' => 'name', 'type' => 'string'],
				'token' => ['column' => $model->table.'.token', 'alias' => 'token', 'type' => 'string'],
				'abilities' => ['column' => $model->table.'.abilities', 'alias' => 'abilities', 'type' => 'string'],
				'last_used_at' => ['column' => $model->table.'.last_used_at', 'alias' => 'last_used_at', 'type' => 'date'],
