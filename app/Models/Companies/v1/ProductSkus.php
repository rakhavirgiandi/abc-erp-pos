...
class ProductSkus extends Model
{
     ...
     */
    protected $casts = [
        'product_id' => 'int', 'sell_price' => 'int', 'sku_code' => 'string', 'alias' => 'string', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'sell_price' => ['column' => $model->table.'.sell_price', 'alias' => 'sell_price', 'type' => 'int'],
				'sku_code' => ['column' => $model->table.'.sku_code', 'alias' => 'sku_code', 'type' => 'string'],
				'alias' => ['column' => $model->table.'.alias', 'alias' => 'alias', 'type' => 'string'],
