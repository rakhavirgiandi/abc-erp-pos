 ...
 */
class ProductMultiPrices extends Model
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'product_multi_prices';
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'from_qty' => ['column' => $model->table.'.from_qty', 'alias' => 'from_qty', 'type' => 'int'],
				'to_qty' => ['column' => $model->table.'.to_qty', 'alias' => 'to_qty', 'type' => 'int'],
