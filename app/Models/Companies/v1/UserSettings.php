...
class UserSettings extends Model
{
     ...
     */
    protected $casts = [
        'name' => 'string', 'key' => 'string', 'value' => 'string', 'type' => 'string', 'description' => 'string', 'is_protected' => 'int', 'is_hidden' => 'int', 'user_id' => 'int', 'order' => 'int', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
