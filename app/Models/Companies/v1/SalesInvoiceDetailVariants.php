...
/**
 * @property int sales_invoice_detail_id
 ...
 */
class SalesInvoiceDetailVariants extends Model
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'sales_invoice_detail_variants';
     ...
     */
    protected $casts = [
        'sales_invoice_detail_id' => 'int', 'variant_id' => 'int', 'option_id' => 'int', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'sales_invoice_detail_id' => ['column' => $model->table.'.sales_invoice_detail_id', 'alias' => 'sales_invoice_detail_id', 'type' => 'int'],
				'variant_id' => ['column' => $model->table.'.variant_id', 'alias' => 'variant_id', 'type' => 'int'],
				'option_id' => ['column' => $model->table.'.option_id', 'alias' => 'option_id', 'type' => 'int'],
