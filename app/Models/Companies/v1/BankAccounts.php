 ...
 * @property int    is_show_in_invoice
 * @property int    is_active
 * @property int    is_default_pos_payment
...
class BankAccounts extends Model
{
     ...
     */
    protected $casts = [
        'bank_name' => 'string', 'account_number' => 'string', 'account_holder_name' => 'string', 'coa' => 'string', 'notes' => 'string', 'is_show_in_invoice' => 'int', 'is_active' => 'int', 'is_default_pos_payment' => 'int', 'deduction' => 'int', 'code' => 'string', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'bank_name' => ['column' => $model->table.'.bank_name', 'alias' => 'bank_name', 'type' => 'string'],
				'account_number' => ['column' => $model->table.'.account_number', 'alias' => 'account_number', 'type' => 'string'],
				'account_holder_name' => ['column' => $model->table.'.account_holder_name', 'alias' => 'account_holder_name', 'type' => 'string'],
				'coa' => ['column' => $model->table.'.coa', 'alias' => 'coa', 'type' => 'string'],
				'notes' => ['column' => $model->table.'.notes', 'alias' => 'notes', 'type' => 'string'],
				'is_show_in_invoice' => ['column' => $model->table.'.is_show_in_invoice', 'alias' => 'is_show_in_invoice', 'type' => 'int'],
				'is_active' => ['column' => $model->table.'.is_active', 'alias' => 'is_active', 'type' => 'int'],
				'is_default_pos_payment' => ['column' => $model->table.'.is_default_pos_payment', 'alias' => 'is_default_pos_payment', 'type' => 'int'],
				'deduction' => ['column' => $model->table.'.deduction', 'alias' => 'deduction', 'type' => 'int'],
