 ...
 * @property string coa
 * @property string key
 * @property string sub_coa
 * @property string order_coa
 ...
 * @property int    is_cash_bank
 * @property int    is_hidden
 * @property int    created_at
 * @property int    updated_at
 * @property int    deleted_at
 */
class AccountingMasters extends Model
{
    use SoftDeletes;
     ...
     */
    protected $casts = [
        'coa' => 'string', 'key' => 'string', 'sub_coa' => 'string', 'order_coa' => 'string', 'accounting_code' => 'string', 'name' => 'string', 'type' => 'string', 'is_active' => 'int', 'is_protected' => 'int', 'cash_flow_type' => 'string', 'is_cash_bank' => 'int', 'is_hidden' => 'int', 'ratio_type' => 'string', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'sub_coa' => ['column' => $model->table.'.sub_coa', 'alias' => 'sub_coa', 'type' => 'string'],
				'order_coa' => ['column' => $model->table.'.order_coa', 'alias' => 'order_coa', 'type' => 'string'],
				'accounting_code' => ['column' => $model->table.'.accounting_code', 'alias' => 'accounting_code', 'type' => 'string'],
				...
				'cash_flow_type' => ['column' => $model->table.'.cash_flow_type', 'alias' => 'cash_flow_type', 'type' => 'string'],
				'is_cash_bank' => ['column' => $model->table.'.is_cash_bank', 'alias' => 'is_cash_bank', 'type' => 'int'],
				'is_hidden' => ['column' => $model->table.'.is_hidden', 'alias' => 'is_hidden', 'type' => 'int'],
				'ratio_type' => ['column' => $model->table.'.ratio_type', 'alias' => 'ratio_type', 'type' => 'string'],
