...
class CacheLocks extends Model
{
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
                				'owner' => ['column' => $model->table.'.owner', 'alias' => 'owner', 'type' => 'string'],
				'expiration' => ['column' => $model->table.'.expiration', 'alias' => 'expiration', 'type' => 'int'],
            ],
            'join' => [
    ...
    public static function getById($id, $params = [], $request = null)
    {
        ...
        $db = ModelHelper::select($schema['field'], $request, __CLASS__)->where($models->table.'.key', $id);
