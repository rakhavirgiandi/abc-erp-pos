 ...
 * @property string default_receivable_coa
 * @property string default_payable_coa
 * @property string default_cash_coa
 * @property string default_bank_coa
...
class Currencies extends Model
{
     ...
     */
    protected $casts = [
        'code' => 'string', 'symbol' => 'string', 'name' => 'string', 'default_receivable_coa' => 'string', 'default_payable_coa' => 'string', 'default_cash_coa' => 'string', 'default_bank_coa' => 'string', 'exchange_rate' => 'int', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'symbol' => ['column' => $model->table.'.symbol', 'alias' => 'symbol', 'type' => 'string'],
				'name' => ['column' => $model->table.'.name', 'alias' => 'name', 'type' => 'string'],
				'default_receivable_coa' => ['column' => $model->table.'.default_receivable_coa', 'alias' => 'default_receivable_coa', 'type' => 'string'],
				'default_payable_coa' => ['column' => $model->table.'.default_payable_coa', 'alias' => 'default_payable_coa', 'type' => 'string'],
				'default_cash_coa' => ['column' => $model->table.'.default_cash_coa', 'alias' => 'default_cash_coa', 'type' => 'string'],
				'default_bank_coa' => ['column' => $model->table.'.default_bank_coa', 'alias' => 'default_bank_coa', 'type' => 'string'],
