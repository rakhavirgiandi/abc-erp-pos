...
class Units extends Model
{
     ...
     */
    protected $casts = [
        'code' => 'string', 'name' => 'string', 'symbol' => 'string', 'is_base' => 'int', 'is_active' => 'int', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'is_base' => ['column' => $model->table.'.is_base', 'alias' => 'is_base', 'type' => 'int'],
