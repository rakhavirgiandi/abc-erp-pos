...
class Taxes extends Model
{
     ...
     */
    protected $casts = [
        'code' => 'string', 'name' => 'string', 'percentage' => 'int', 'purchase_coa' => 'string', 'sales_coa' => 'string', 'is_active' => 'int', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'percentage' => ['column' => $model->table.'.percentage', 'alias' => 'percentage', 'type' => 'int'],
				'purchase_coa' => ['column' => $model->table.'.purchase_coa', 'alias' => 'purchase_coa', 'type' => 'string'],
