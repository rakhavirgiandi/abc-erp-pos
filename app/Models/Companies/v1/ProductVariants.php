 ...
 * @property string variant_option_ids
 */
class ProductVariants extends Model
{
     ...
     */
    protected $casts = [
        'product_id' => 'int', 'variant_id' => 'int', 'variant_option_id' => 'int', 'sequence' => 'int', 'variant_option_ids' => 'string', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'variant_id' => ['column' => $model->table.'.variant_id', 'alias' => 'variant_id', 'type' => 'int'],
				'variant_option_id' => ['column' => $model->table.'.variant_option_id', 'alias' => 'variant_option_id', 'type' => 'int'],
				'sequence' => ['column' => $model->table.'.sequence', 'alias' => 'sequence', 'type' => 'int'],
				'variant_option_ids' => ['column' => $model->table.'.variant_option_ids', 'alias' => 'variant_option_ids', 'type' => 'string'],
