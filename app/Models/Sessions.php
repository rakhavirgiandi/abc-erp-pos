...
class Sessions extends Model
{
     ...
     */
    protected $casts = [
        'user_id' => 'int', 'ip_address' => 'string', 'user_agent' => 'string', 'payload' => 'string', 'last_activity' => 'int'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'ip_address' => ['column' => $model->table.'.ip_address', 'alias' => 'ip_address', 'type' => 'string'],
				'user_agent' => ['column' => $model->table.'.user_agent', 'alias' => 'user_agent', 'type' => 'string'],
				'payload' => ['column' => $model->table.'.payload', 'alias' => 'payload', 'type' => 'string'],
				'last_activity' => ['column' => $model->table.'.last_activity', 'alias' => 'last_activity', 'type' => 'int'],
            ],
            'join' => [
