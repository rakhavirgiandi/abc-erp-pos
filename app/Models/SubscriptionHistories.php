...
class SubscriptionHistories extends Model
{
     ...
     */
    protected $casts = [
        'subscription_id' => 'string', 'company_id' => 'string', 'start_at' => 'datetime', 'finish_at' => 'datetime', 'status' => 'string', 'referral_code' => 'string', 'deleted_at' => 'datetime', 'created_at' => 'datetime', 'updated_at' => 'datetime'
    ];
     ...
     */
    protected $dates = [
        'start_at', 'finish_at', 'deleted_at', 'created_at', 'updated_at'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'subscription_id' => ['column' => $model->table.'.subscription_id', 'alias' => 'subscription_id', 'type' => 'string'],
				'company_id' => ['column' => $model->table.'.company_id', 'alias' => 'company_id', 'type' => 'string'],
				'start_at' => ['column' => $model->table.'.start_at', 'alias' => 'start_at', 'type' => 'date'],
				'finish_at' => ['column' => $model->table.'.finish_at', 'alias' => 'finish_at', 'type' => 'date'],
