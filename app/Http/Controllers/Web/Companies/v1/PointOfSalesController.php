...
class PointOfSalesController extends Controller
{
    ...
    public function cashier()
    {
        ...
        return view('companies.v1.pos.cashier.index', compact('title'));
    }
    ...
    public function printReceipt(Request $request, $number)
    {
        ...
        return view('companies.v1.pos.print.receipt', ['data' => $data->toArray(), 'paper_size' => $paper_size]);

    }

    public function settings(Request $request)
    {
        return view('companies.v1.pos.settings', ['title' => 'Settings']);
    }
