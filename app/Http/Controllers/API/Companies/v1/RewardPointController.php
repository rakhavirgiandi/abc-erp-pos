...
class RewardPointController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = RewardPoints::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = RewardPoints::getAllResult($params, $request);
        } else {
    ...
    {
        $params = $request->all();
        return RewardPoints::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return RewardPoints::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return RewardPoints::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = RewardPoints::datatables($start, $limit, $order, $dir, $search, $filter);
    ...
    public static function syncToLocal(Request $request)
    {
        ...
        do {
            $url = config('services.admin_credentials.server_url') . "/api/v1/reward_points?page={$page}&per_page={$perPage}&is_simple=true&order[id]=asc";
