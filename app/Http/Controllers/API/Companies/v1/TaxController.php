...
class TaxController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = Taxes::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = Taxes::getAllResult($params, $request);
        } else {
    ...
    {
        $params = $request->all();
        return Taxes::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return Taxes::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return Taxes::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = Taxes::datatables($start, $limit, $order, $dir, $search, $filter);
    ...
    public static function syncToLocal(Request $request)
    {
        ...
        do {
            $url = config('services.admin_credentials.server_url') . "/api/v1/taxes?page={$page}&per_page={$perPage}&is_simple=true&order[id]=asc";
