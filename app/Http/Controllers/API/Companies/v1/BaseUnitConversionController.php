...
use App\Models\Companies\v1\BaseUnitConversions;
use Illuminate\Http\Request;

class BaseUnitConversionController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = BaseUnitConversions::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = BaseUnitConversions::getAllResult($params, $request);
        } else {
            $res = BaseUnitConversions::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return BaseUnitConversions::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return BaseUnitConversions::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return BaseUnitConversions::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = BaseUnitConversions::datatables($start, $limit, $order, $dir, $search, $filter);
    ...
    public static function syncToLocal(Request $request)
    {
        ...
        do {
            $url = config('services.admin_credentials.server_url') . "/api/v1/base_unit_conversions?page={$page}&per_page={$perPage}&is_simple=true&order[id]=asc";
        ...
        return response()->json([
            'status' => 'success',
            'message' => 'Sync base unit berhasil',
        ]);
    }
}
