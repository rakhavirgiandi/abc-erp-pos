...
use App\Models\Companies\v1\ProductMultiPrices;
use App\Models\Companies\v1\Products;
use Illuminate\Http\Request;

class ProductMultiPriceController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = ProductMultiPrices::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = ProductMultiPrices::getAllResult($params, $request);
        } else {
            $res = ProductMultiPrices::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return ProductMultiPrices::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return ProductMultiPrices::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return ProductMultiPrices::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = ProductMultiPrices::datatables($start, $limit, $order, $dir, $search, $filter);
    ...
    public static function syncToLocal(Request $request)
    {
        ...
        do {
            $url = config('services.admin_credentials.server_url') . "/api/v1/product_multi_prices?page={$page}&per_page={$perPage}&is_simple=true&order[id]=asc";
