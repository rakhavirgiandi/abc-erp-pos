...
use App\Models\Companies\v1\Variants;
...
class VariantController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = Variants::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = Variants::getAllResult($params, $request);
        } else {
            $res = Variants::getPaginatedResult($params, $request);
        }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return Variants::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return Variants::approveById($id, $params, $request);
    }
    ...
    public static function syncToLocal(Request $request)
    {
        ...
        do {
            $url = config('services.admin_credentials.server_url') . "/api/v1/variants?page={$page}&per_page={$perPage}&is_simple=true&order[id]=asc";
