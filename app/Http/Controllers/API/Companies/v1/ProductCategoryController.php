...
class ProductCategoryController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = ProductCategories::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = ProductCategories::getAllResult($params, $request);
        } else {
    ...
    {
        $params = $request->all();
        return ProductCategories::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return ProductCategories::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return ProductCategories::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = ProductCategories::datatables($start, $limit, $order, $dir, $search, $filter);
    ...
    public static function syncToLocal(Request $request)
    {
        ...
        do {
            $url = config('services.admin_credentials.server_url') . "/api/v1/product_categories?page={$page}&per_page={$perPage}&is_simple=true&order[id]=asc";
