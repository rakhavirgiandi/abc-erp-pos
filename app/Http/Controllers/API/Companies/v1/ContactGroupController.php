...
class ContactGroupController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = ContactGroups::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = ContactGroups::getAllResult($params, $request);
        } else {
    ...
    {
        $params = $request->all();
        return ContactGroups::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return ContactGroups::deleteById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = ContactGroups::datatables($start, $limit, $order, $dir, $search, $filter);
