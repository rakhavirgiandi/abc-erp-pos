...
use App\Models\Companies\v1\ModelHasPermissions;
...
class ModelHasPermissionController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = ModelHasPermissions::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = ModelHasPermissions::getAllResult($params, $request);
        } else {
            $res = ModelHasPermissions::getPaginatedResult($params, $request);
        }
