...
class RegRegencyController extends Controller
{
    public function get(Request $request,$id=null )
    {
        ...
        if ($id != null) {
            $res = RegRegencies::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = RegRegencies::getAllResult($params, $request);
        } else {
            $res = RegRegencies::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return RegRegencies::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function put(Request $request, $id)
    {
        $params = $request->all();
        $params['id'] = $id;
        return RegRegencies::createOrUpdate($params, $request->method());
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return RegRegencies::deleteById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = RegRegencies::datatables($start, $limit, $order, $dir, $search, $filter);
