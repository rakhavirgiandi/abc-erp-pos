...
class CompletedJobController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = CompletedJobs::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = CompletedJobs::getAllResult($params, $request);
        } else {
            $res = CompletedJobs::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return CompletedJobs::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete($id, Request $request)
    {
        ...
        return CompletedJobs::deleteById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = CompletedJobs::datatables($start, $limit, $order, $dir, $search, $filter);
