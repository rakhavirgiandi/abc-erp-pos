...
class RegProvinceController extends Controller
{
    public function get(Request $request, $id=null)
    {
        ...
        if ($id != null) {
            $res = RegProvinces::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = RegProvinces::getAllResult($params, $request);
        } else {
            $res = RegProvinces::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return RegProvinces::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function put(Request $request, $id)
    {
        $params = $request->all();
        $params['id'] = $id;
        return RegProvinces::createOrUpdate($params, $request->method());
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return RegProvinces::deleteById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = RegProvinces::datatables($start, $limit, $order, $dir, $search, $filter);
