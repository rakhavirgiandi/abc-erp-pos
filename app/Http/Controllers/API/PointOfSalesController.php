...
use App\Models\ContactGroupPointRules;
...
class PointOfSalesController extends Controller
{
    ...
    public function payment (Request $request)
    {
        ...
        $params['warehouse_name'] = $warehouse ? $warehouse->id : config('general_settings.warehouse_name');
        $params['branch_id'] = $branch ? $branch->id : config('general_settings.default_branch');
        $params['branch_name'] = $branch ? $branch->id : config('general_settings.branch_name');
